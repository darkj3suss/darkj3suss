<h1 align="center" style="color:#f012be;">🌌 Welcome, traveler of the source</h1>

<p align="center">
  <img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&size=30&pause=500&color=F72585&center=true&vCenter=true&width=640&lines=xd." />
</p>

---

## About Me
- Curious by nature, developer by habit  
- I enjoy learning, building, and sometimes rewriting it all  
- Mostly backend, often fullstack, occasionally frontend (with caution)  
- Always working on something weird at 2AM  
- Backend-focused, Python-powered, C-tainted  
- Building APIs, CLI tools, and breaking things on weekends  
- Strong opinions, loosely typed (unless it’s C++)  
...
## Current Focus
- Support dot-i18n
- Building FastAPI services with PostgreSQL & async love  
- Refactoring C++ utilities no one will ever see 
---
...
If you enjoy anything I make and want to keep the terminal glowing:
...
> “Clean code is a matter of style, persistence, and a tiny bit of suffering.”
